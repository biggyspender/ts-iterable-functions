...
export { all, all as every, _all, _all as _every } from './transformers/all'
...
export { select as map, select, _select as _map, _select } from './transformers/select'
export {
  selectMany,
  selectMany as flatMap,
  _selectMany,
  _selectMany as _flatMap
} from './transformers/selectMany'
...
export { where as filter, where, _where as _filter, _where } from './transformers/where'
